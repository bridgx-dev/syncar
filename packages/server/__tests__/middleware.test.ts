    ...
    describe('rejection', () => {
        ...
        it('should provide rejection reason', async () => {
            ...
            try {
                ...
                expect((error as MiddlewareRejectionError).reason).toBe(
                    'Custom reason',
                )
                expect((error as MiddlewareRejectionError).action).toBe(
                    'connect',
                )
            }
        })
        ...
        it('should wrap thrown errors in MiddlewareExecutionError', async () => {
            ...
            try {
                ...
                expect((error as MiddlewareExecutionError).action).toBe(
                    'connect',
                )
            }
        })
