    ...
    describe('constructor', () => {
        it('should create error with reason and action', () => {
            ...
            expect(error.message).toBe(
                "Action 'subscribe' rejected: Not authorized",
            )
        })
...
describe('MiddlewareExecutionError', () => {
    ...
    describe('constructor', () => {
        ...
        it('should generate descriptive message', () => {
            ...
            expect(error.message).toBe(
                'Middleware execution error in auth-middleware during connect: Database connection failed',
            )
        })
    ...
    describe('toString()', () => {
        it('should format error as string', () => {
            ...
            expect(error.toString()).toBe(
                '[MiddlewareExecutionError] auth-check failed during subscribe: Database connection failed',
            )
        })
    })
...
describe('Error inheritance chain', () => {
    it('should maintain instanceof checks', () => {
        ...
        const executionError = new MiddlewareExecutionError(
            'test',
            'test',
            new Error('cause'),
        )
