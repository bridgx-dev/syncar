    ...
    describe('Channel Name Validation', () => {
        describe('isValidChannelName', () => {
            ...
            it('should reject non-string values', () => {
                ...
                expect(isValidChannelName(undefined as unknown as '')).toBe(
                    false,
                )
        ...
        describe('assertValidChannelName', () => {
            ...
            it('should throw for too long names', () => {
                expect(() => assertValidChannelName('a'.repeat(129))).toThrow(
                    'Invalid channel name',
                )
            })
        })
    ...
    describe('Message Utilities', () => {
        ...
        describe('createSignalMessage', () => {
            ...
            it('should handle all signal types', () => {
                const subscribeMsg = createSignalMessage(
                    'chat',
                    SignalType.SUBSCRIBE,
                )
                const unsubscribeMsg = createSignalMessage(
                    'chat',
