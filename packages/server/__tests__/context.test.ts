    ...
    describe('createContext', () => {
        ...
        describe('reject()', () => {
            it('should throw an error with the provided reason', () => {
                ...
                expect(() => context.reject('Not allowed')).toThrow(
                    'Not allowed',
                )
            })
            ...
            it('should include action in error message', () => {
                ...
                expect(() => context.reject('Forbidden')).toThrow(
                    "Action 'subscribe' rejected: Forbidden",
                )
            })
        })
    })
    ...
    describe('ContextManager', () => {
        ...
        describe('use()', () => {
            it('should register middleware', () => {
                const middleware: Middleware = vi.fn(async (_ctx, next) =>
                    next(),
                )
        ...
        describe('createConnectionContext()', () => {
            it('should create context for connect action', () => {
                ...
                const context = manager.createConnectionContext(
                    client,
                    'connect',
                )
        ...
        describe('getPipeline()', () => {
            ...
            it('should include channel middleware when provided', () => {
                ...
                const channelMw: Middleware = vi.fn(async (_ctx, next) =>
                    next(),
                )
