...
describe('reconnection', () => {
  ...
  describe('calculateBackoffWithJitter', () => {
    it('produces consistent results with same seed', () => {
      const delay1 = calculateBackoffWithJitter(3, 42, { jitterFactor: 0.5 })
      const delay2 = calculateBackoffWithJitter(3, 42, { jitterFactor: 0.5 })
    ...
    it('produces different results with different seeds', () => {
      const delay1 = calculateBackoffWithJitter(3, 42, { jitterFactor: 0.5 })
      const delay2 = calculateBackoffWithJitter(3, 99, { jitterFactor: 0.5 })
  ...
  describe('ReconnectionState', () => {
    ...
    it('advances reconnection state', () => {
      ...
      expect(nextState.currentDelay).toBeGreaterThan(initialState.currentDelay)
