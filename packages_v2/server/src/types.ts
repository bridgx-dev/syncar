/**
 * Server Types
 * Type definitions for the @synnel/server-v2 package
 */

import type { Message, DataMessage, ChannelName } from '@synnel/core-v2'
import type { ServerTransport, ClientConnection } from '@synnel/adapter-ws-v2'
